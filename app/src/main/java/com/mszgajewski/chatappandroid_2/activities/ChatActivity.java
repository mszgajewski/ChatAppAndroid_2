package com.mszgajewski.chatappandroid_2.activities;
...
import com.mszgajewski.chatappandroid_2.adapters.ChatAdapter;
import com.mszgajewski.chatappandroid_2.databinding.ActivityChatBinding;
import com.mszgajewski.chatappandroid_2.models.ChatMessage;
import com.mszgajewski.chatappandroid_2.models.User;
import com.mszgajewski.chatappandroid_2.network.ApiClient;
import com.mszgajewski.chatappandroid_2.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendNotification(String messageBody) {
        ApiClient.getClient().create(ApiService.class).sendMeesage(Constants
        .getRemoteMsgHeaders(),messageBody).enqueue(new Callback<String>() {
            @Override
            public void onResponse(@NonNull Call<String> call,@NonNull Response<String> response) {
                if (response.isSuccessful()) {
                    ...
                    showToast("Powiadomienie wysłane");
                } else {
                    showToast("Błąd: " + response.code());
                }
            }
        ...
        database.collection(Constants.KEY_COLLECTION_USERS).document(receiverUser.id)
                ...
                if (value != null) {
                    ...
                    if (receiverUser.image == null) {
                        receiverUser.image = value.getString(Constants.KEY_FCM_TOKEN);
